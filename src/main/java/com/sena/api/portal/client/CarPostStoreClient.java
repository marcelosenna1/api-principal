package com.sena.api.portal.client;
...
public class CarPostStoreClient {
    ...
    public List<CarPostDTO> carForSaleClient(){
        ResponseEntity<CarPostDTO[]> responseEntity = restTemplate
                .getForEntity(POSTS_STORE_SERVICE_URI+"/cars", CarPostDTO[].class);
    ...
    public void deleteCarForSaleClient(String id){
        restTemplate.delete(POSTS_STORE_SERVICE_URI+"/car/"+id,CarPostDTO.class);
    }
